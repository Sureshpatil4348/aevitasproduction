...
const ChannelCard = ({ title, category, subscribers, views, thumbnailSrc, delay = 0 }: { title: string; category: string; subscribers: string; views: string; thumbnailSrc: string; delay?: number }) => {
  return (
    <motion.div
